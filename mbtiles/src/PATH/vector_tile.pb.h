...
// source: PATH/vector_tile.proto

#ifndef GOOGLE_PROTOBUF_INCLUDED_PATH_2fvector_5ftile_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_PATH_2fvector_5ftile_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_PATH_2fvector_5ftile_2eproto
...
struct TableStruct_PATH_2fvector_5ftile_2eproto {
...
class Tile_Value PROTOBUF_FINAL :
 ...
 private:
  ...
  friend struct ::TableStruct_PATH_2fvector_5ftile_2eproto;
};
// -------------------------------------------------------------------
...
class Tile_Feature PROTOBUF_FINAL :
 ...
 public:
  ...
  void _internal_set_raster(const std::string& value);
...
inline void Tile_Value::set_string_value(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
...
// optional bytes raster = 5;
inline bool Tile_Feature::_internal_has_raster() const {
  bool value = (_has_bits_[0] & 0x00000001u) != 0;
  return value;
}
...
template <typename ArgT0, typename... ArgT>
PROTOBUF_ALWAYS_INLINE
inline void Tile_Feature::set_raster(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 raster_.SetBytes(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArena());
...
inline std::string* Tile_Feature::mutable_raster() {
  ...
  return _internal_mutable_raster();
}
inline const std::string& Tile_Feature::_internal_raster() const {
  return raster_.Get();
}
inline void Tile_Feature::_internal_set_raster(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  raster_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline std::string* Tile_Feature::_internal_mutable_raster() {
  _has_bits_[0] |= 0x00000001u;
  return raster_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* Tile_Feature::release_raster() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  return raster_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void Tile_Feature::set_allocated_raster(std::string* raster) {
  ...
  raster_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), raster,
      GetArena());
...
template <typename ArgT0, typename... ArgT>
PROTOBUF_ALWAYS_INLINE
inline void Tile_Layer::set_name(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_PATH_2fvector_5ftile_2eproto
