...
constexpr Tile_Feature::Tile_Feature(
  ...
  , raster_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
...
Tile_Feature::Tile_Feature(const Tile_Feature& from)
  ...
  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
  raster_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (from._internal_has_raster()) {
    raster_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, from._internal_raster(), 
      GetArena());
  }
  ::memcpy(&id_, &from.id_,
...
void Tile_Feature::SharedDtor() {
  GOOGLE_DCHECK(GetArena() == nullptr);
  raster_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
...
// @@protoc_insertion_point(message_clear_start:vector_tile.Tile.Feature)
  ...
  cached_has_bits = _has_bits_[0];
  if (cached_has_bits & 0x00000001u) {
    raster_.ClearNonDefaultToEmpty();
  }
...
::PROTOBUF_NAMESPACE_ID::uint8* Tile_Feature::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000001u) {
    target = stream->WriteBytesMaybeAliased(
        5, this->_internal_raster(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:vector_tile.Tile.Feature)
  ...
  if (cached_has_bits & 0x00000007u) {
    if (cached_has_bits & 0x00000001u) {
      _internal_set_raster(from._internal_raster());
    }
    if (cached_has_bits & 0x00000002u) {
      id_ = from.id_;
    }
...
void Tile_Feature::InternalSwap(Tile_Feature* other) {
  ...
  raster_.Swap(&other->raster_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
